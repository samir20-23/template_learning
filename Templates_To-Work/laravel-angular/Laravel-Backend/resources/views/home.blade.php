                    ...
                    <div class="sidebar-section">
                        ...
                        <div class="recent-list">
                            @foreach ($recentDocuments as $doc)
                                <a href="{{ route('documents.show', $doc) }}" class="recent-item">
                    ...
                    <div class="documents-grid" id="documentsContainer" data-aos="fade-up" data-aos-delay="200">
                        @forelse($documents as $document)
                            <div class="document-card">
                                ...
                                <div class="document-footer">
                                    <a href="{{ route('documents.show', $document) }}" class="btn-view">
                                        <i class="fas fa-eye me-2"></i>View
                                    </a>
                                    <a href="{{ $document->getDownloadUrl() }}" class="btn-download">
                                        <i class="fas fa-download me-2"></i>Download
                                    </a>
                                </div>
                            </div>
                        @empty
                            <div class="no-documents">
                                ...
                                <p class="no-documents-text">Try adjusting your search criteria or browse different
                                    categories.</p>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            window.toggleFavorite = function(documentId) {
                // This would typically make an AJAX call to toggle favorite status
